...
export const searchBoxSlice = createSlice({
  ...
  reducers: {
    ...
    setStateListArrayList: (state, action) => {
        state.stateListArrayList = action.payload;
    },
    ...
    setStateMJStatusListArray: (state, action) => {
        state.stateMJStatusListArray = action.payload;
    },
    ...
    setStateMJMedicinalStatusListArray: (state, action) => {
        state.stateMJMedicinalStatusListArray = action.payload;
    },
    ...
    setStateMJCriminalStatusListArray: (state, action) => {
        state.stateMJCriminalStatusListArray = action.payload;
    },
